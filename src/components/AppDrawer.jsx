      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div 
            ...
            className="absolute top-12 -right-2 md:-right-4 w-80 bg-[var(--bg-color)] p-4 shadow-2xl z-50 border border-slate-700/50 rounded-2xl transition-colors duration-300"
          >
